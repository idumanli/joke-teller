...
async function getJoke() {
	 const apiUarl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
	 let joke = '';
	try {

       const response = await fetch(apiUarl);
...
// add eventListener
button.addEventListener('click', getJoke, toggleButton);
